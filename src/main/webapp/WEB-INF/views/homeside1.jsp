  ...
  <div class="row">
	...
	<div class="navbar-header">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a href="LoginTry2.html"><i class="fa fa-sign-in fa-lg" aria-hidden="true"></i> Login</a></li>
		</ul>
			</div>
		...
		<ul class="nav  nav-pills nav-tabs nav-justified">
			<li class="dropdown"><a href="Apple_Prds-Page.html"><i class="fa fa-apple fa-lg" style="color:#8e8e93" aria-hidden="true"></i> Apple</a>

			</li>
			<li class="dropdown"><a href="Android_Prds-Page.html"><i class="fa fa-android fa-lg" style="color:#6ab344" aria-hidden="true"></i> Android</a>
				
			</li>
			<li class="dropdown"><a href="Windows_Prds-Page.html"><i class="fa fa-windows fa-lg" style="color:#0078d7" aria-hidden="true"></i> Windows</a>
...
<div class="item">
	...
	<img src="/MISC/Home/Caro/windows-600x400.jpg" alt="" width="600" height="400">
	<div class="carousel-caption">
	<h3>Windows</h3>
	</div>
</div><!--item3-->
...
<div class="item">
	...
	<img src="/MISC/Home/Caro/Androi-watch-600x400.jpg" alt="" width="600" height="400">
	<div class="carousel-caption">
	<h3>Android watch</h3>
	</div>
</div><!--item4-->
